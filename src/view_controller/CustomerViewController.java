...
public class CustomerViewController {
   ...
   * <p>
   * <strong>DISCUSSION OF {@index LAMBDA_4}</strong> - <blockquote>Lambda used to add focus listeners to all field controls
  ...
  /**
   * Overloaded method initializes user data and isNew flag for customer scene
   * and prepares labels.
   *
   ...
   *
   * @param event ActionEvent generated by user selecting division combo box.
   */
  @FXML
   ...
   *
   * @param event ActionEvent generated by user selecting country combo box.
   */
  @FXML
